...
const insertScript = (src, id, parentElement) => {
    ...
    script.src = src
    script.id = id
    script.setAttribute("data-no-fonts", true); // turn off Google fonts
    script.setAttribute("data-css-override", `${location.origin}/styles/commento.css`); // turn off Google fonts
